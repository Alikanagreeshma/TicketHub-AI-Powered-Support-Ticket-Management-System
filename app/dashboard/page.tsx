      ...
      <div className="flex-1 overflow-auto">
        ...
        <main className="p-6 space-y-6">
          ...
          <div>
            ...
            <p className="text-muted-foreground mt-1">Manage and track your support tickets</p>
          </div>
          ...
          <div>
            ...
            {loading ? (
              ...
              <div className="text-center py-8 text-muted-foreground">No tickets found. Create one to get started!</div>
            ) : (
